...
<div className="flex flex-col justify-center items-center min-h-screen  ">
  ...
  <div className="container mx-auto mt-8 lg:py-16 px-4 lg:px-20 md:px-8 flex flex-col-reverse lg:flex-row items-center justify-between  ">
    {/* Texto */}
    ...
    <div className="lg:w-1/3 flex justify-center lg:justify-end order-2 lg:order-none mb-8 lg:mb-0">
      <Image
        src="/pp.jpeg"
        alt="Your Name"
        width={200}
