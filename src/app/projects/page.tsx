...
export default function Projects() {
  ...
  const projects = [
    {
      id: "arvedson-art",
      title: t("arvedson_art_title"),
      description: t("arvedson_art_short_description"),
      imageLight: "/arvedsonartlight.png",
      imageDark: "/arvedsonarthomepage.png",
      url: "/projects/arvedson-art",
    },
    {
      id: "todo-app",
